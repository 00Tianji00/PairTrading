...
class _UpdateCTP(object):
    ...
    def update(self, tick, instrument):
...
def select_updater(exchange):
    ...
    class DataUpdater(obj):
        ...
        #         self.period[period]['cur_interval'] = df.index[-1]
        #         self.period[period]['past_interval'] = df.index[-1]
        ...
        def set_default_data(self, df):
            ...
            for i in self.period:
                ...
                index = getattr(self.marketdata, period).index[-1]
